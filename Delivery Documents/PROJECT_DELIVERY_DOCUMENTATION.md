...
└── README_WIFI_BACKEND.md    # Firmware setup guide
```
...
**Note**: Backend is located at `D:\Projects\plant-sensor-backend\` (outside main project folder)
...
5. **Battery Configuration**:
   ...
   - **Battery-only runtime**: ~11 days (with 80% DoD)
...
6. **Solar Charging**:
   ...
   - **Cloudy days** (1h sunlight): -0.09 Ah/day deficit, but battery lasts 77+ days
...
- SMS/email alerts for out-of-range sensor readings
...
- `README_WIFI_BACKEND.md` (in firmware folder): WiFi setup and memory estimates
- `SETUP_AND_TROUBLESHOOTING.md`: Comprehensive setup guide
- `PROJECT_WORKFLOW_WIFI.md`: Original development workflow documentation
